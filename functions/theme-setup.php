...
function ip_scripts_styles()
{
    ...
    wp_enqueue_script('parallax_script', get_template_directory_uri() . '/js/parallax.js',array('jquery'), null, true);
    wp_enqueue_style('ip_style', get_template_directory_uri() . '/css/global.css', false, null);
    wp_enqueue_script('typed_script', get_template_directory_uri() . '/js/typed.js',array('jquery'), null, true);
    if (is_singular('post')){
